...
# 2. read dataframe
m <- read.table("analysis/intersection.intergenic.tsv", h=F, sep="\t")
...
pdf("~/public_html/enhancers_neural_development/plots/fig.10.pdf", width = 10, height = 4.5)
ggplot(m, aes(x=group, y=percentage, fill=group)) +
  ...
  ylab("% of ELS not overlapping genes") +
