...
pdf("~/public_html/enhancers_neural_development/figures.paper/fig.1c.pdf",
    height = 8, width = 9)
pheatmap(y*100, cluster_cols = F, cluster_rows = F,
         border_color = NA,
         cellwidth = 10,
         cellheight = 10,
         annotation_row = metadata[z, "group", drop=F],
         annotation_col = metadata[z, "group", drop=F],
         annotation_colors = list(group = c("brain" = "#EEEE00",
                                            "blood" = "#FF00BB",
                                            "muscle" = "#9e9ac8",
                                            "iPS" ="gray",
